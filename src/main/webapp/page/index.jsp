		...
		<div id="header">
			...
			<div class="headerNav">
				...
				<ul class="nav">
					...
					<li><a href="/TestOne/user/userViewOwnInfo" target="dialog" width="500" height="400" style="color:#fff;">帐号信息</a></li>
					<li><a href="/TestOne/user/userChangeOwnPwdUI" target="dialog" width="550" height="300" style="color:#fff;">修改密码</a></li>
					<li>
						<a href="/TestOne/login/logoutConfirm" title="退出登录确认" target="dialog" width="300" height="200" style="color:#fff;">退出</a>
					</li>
				</ul>
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a href="../user/listPmsUser" target="navTab" rel="listPmsUser" fresh="true">用户信息管理</a></li>
						</ul>
					</div>
