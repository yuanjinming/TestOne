...
<div class="pageContent">
	<form id="form" method="post" action="/TestOne/user/addPmsUser" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="60">
			...
			<p style="width:99%">
				<label>用户姓名：</label>
				<input name="userName" cssClass="required" minlength="2" maxlength="45" size="30" />
			</p>
			<p style="width:99%">
				<label>用户登录名：</label>
			...
			<p style="width:99%">
				<label>手机号码：</label>
				<input name="mobileNo" cssClass="required mobile"  maxlength="12" size="30" />
			</p>
			<p style="width:99%">
				<label>状态：</label>
			...
			<p style="width:99%;height:50px;">
				<label>描述：</label>
				<textarea name="desc" cssClass="required" maxlength="100" rows="3" cols="30"></textarea>
			</p>
		</div>
		<div class="formBar">
			<ul>
